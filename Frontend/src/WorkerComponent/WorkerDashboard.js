...
export default function WorkerDashboard() {
  ...
  const fetchWorkerData = async () => {
    ...
    try {
      const res = await axios.get(`${API_BASE_URL}/api/workers/${data._id}`);
      ...
      const bookingsRes = await axios.get(`${API_BASE_URL}/api/bookings/worker/${data._id}`);
  ...
  // Automatic online/offline system in place. No manual toggle allowed.
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-green-50 to-emerald-50 flex flex-col">
